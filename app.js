...
window.addEventListener('load', () => {
    // Ensure the site loads in light mode by removing the "dark" class
    document.body.classList.remove('dark');

    // Set the icon to moon (so the user can switch to dark mode)
...
var typed = new Typed('.typing', { strings: ["", "Radon Testing", "Air Quality Testing", "Mold Testing", "24 hr Reports"], typeSpeed: 100, Backspeed: 60, loop: true })
